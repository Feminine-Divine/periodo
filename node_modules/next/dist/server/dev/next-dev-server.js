...
class DevServer extends _nextServer.default {
    ...
    async startWatcher() {
        ...
        return new Promise(async (resolve, reject)=>{
            ...
            const files1 = (0, _utils3).getPossibleMiddlewareFilenames((0, _path).join(rootDir, ".."), this.nextConfig.pageExtensions);
        ...
        if ((0, _isError).default(err) && err.stack) {
            try {
                ...
                if (frame.lineNumber && (frame == null ? void 0 : frame.file)) {
                    var ref, ref19, ref20, ref21, ref22, ref23, ref24, ref25, ref26, ref27;
                    ...
                    const compilation = isEdgeCompiler ? (ref = this.hotReloader) == null ? void 0 : (ref19 = ref.edgeServerStats) == null ? void 0 : ref19.compilation : (ref20 = this.hotReloader) == null ? void 0 : (ref21 = ref20.serverStats) == null ? void 0 : ref21.compilation;
                    const source = await (0, _middleware).getSourceById(!!((ref22 = frame.file) == null ? void 0 : ref22.startsWith(_path.sep)) || !!((ref23 = frame.file) == null ? void 0 : ref23.startsWith("file:")), moduleId, compilation);
                    const originalFrame = await (0, _middleware).createOriginalStackFrame({
                        ...
                        serverCompilation: isEdgeCompiler ? undefined : (ref24 = this.hotReloader) == null ? void 0 : (ref25 = ref24.serverStats) == null ? void 0 : ref25.compilation,
                        edgeCompilation: isEdgeCompiler ? (ref26 = this.hotReloader) == null ? void 0 : (ref27 = ref26.edgeServerStats) == null ? void 0 : ref27.compilation : undefined
                    });
                    if (originalFrame) {
