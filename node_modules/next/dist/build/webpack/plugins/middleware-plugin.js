...
exports.handleWebpackExternalForEdgeRuntime = handleWebpackExternalForEdgeRuntime;
...
function getEntryFiles(entryFiles, meta, opts) {
    ...
    if (meta.edgeSSR) {
        ...
        if (opts.hasFontLoaders) {
            files.push(`server/${_constants.FONT_LOADER_MANIFEST}.js`);
        }
    }
...
function getCreateAssets(params) {
    ...
    return (assets)=>{
        ...
        for (const entrypoint of compilation.entrypoints.values()){
            ...
            const { namedRegex  } = (0, _routeRegex).getNamedMiddlewareRegex(((ref3 = metadata.edgeSSR) == null ? void 0 : ref3.isAppDir) ? (0, _appPaths).normalizeAppPath(page) : page, {
