      ...
      return (
        <ChatBot
          steps={[
            ...
            {
              id: '21',
              message: 'Hey! This ChatBot is all about diets and how to get rid of period cramps for women. Are you interested to know about this, so that you can take care of your women during her periods ;) Here is a tip: women love care when she is on her period. ',
              trigger: 'male',
            },
...

        {
          ...
          {
          id: '31',
          message : 'Okay so Hey! This ChatBot is all about diets and how to get rid of period cramps for women. So do you want to know more about?',
          trigger : 'period',
        },
        ...
        },
        {
          ...
          {
          id: '13',
          message : 'So, do not worry about! here I am to help you :) This are the diets you must include: 1. Water 2.Fruits 3.Leafy green vegetables 4. Ginger 5.Chicken 6.Fish 6.Turmeric 8.Dark Chocolates 9.Nuts 10.Yogurt  And Foods that you need to avoid: 1.Coffee 2.Alcohol 3.Spicy Food 4.Salt and Sugar: Intake in limited amount. Yeah so these are the tips you have to follow!✌🏻',
          trigger : 'sol',
        },
        {
          id: 'sol',
        ...
        {
          id:'14',
          message: 'Are you feeling frustrated or irritated due to period cramps?',
          trigger: 'cramps',
        },
        {
            id: 'cramps',
          ...
          {
          id: '15',
          message : 'Here are some things that help ease cramps: 1.Exercise. 2.Putting a heating pad on your belly or lower back. 3.Taking a hot bath. 4.Having an orgasm (by yourself or with a partner). 5.Rest.  So Yeah this are the technique that help to give relaxation from the cramps.',
          trigger : 'sol1',
        },
        ...
        {
          id:'16',
          message: 'Want to know about the medications that relax you from the period cramps?',
